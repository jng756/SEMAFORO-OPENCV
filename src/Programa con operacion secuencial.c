...
//carros a determinar trafico
#define CARROS1 3
#define CARROS2 4

#define TIMEOUT 5

#define MIN_TIME_GREEN 1
...
int main()
{
	...
	dest2=cvPoint(0,0);
	//Percent resize
	int input_resize_percent = RESIZE;
  ...
  cvMoveWindow("semaforo 1", 620, 0);
  cvMoveWindow("semaforo 2", 990, 0);
  ...
  cvShowImage("image1", frame1);
  cvMoveWindow("image1", 620, 550);
  cvShowImage("image2", frame2);
  cvMoveWindow("image2", 990, 550);
		  do
		  {
